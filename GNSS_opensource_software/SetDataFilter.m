...
% dataFilter{end,2}   = 'Svid ~= 15 & Svid ~= 25 & Svid ~= 26';
% 
...
% dataFilter{end+1,1} = 'utcTimeMillis'; 
% dataFilter{end,2}   = 'utcTimeMillis > 1653048970999'; %& utcTimeMillis < 1653048976999


%limit to GPS only:
dataFilter{end+1,1} = 'ConstellationType'; 
dataFilter{end,2}   = '(ConstellationType)==1'; 
% dataFilter{end,2}   = '(ConstellationType)==5'; 
...
% CodeType
% dataFilter{end+1,1} = 'CodeType'; 
% dataFilter{end,2}   = 'strcmp(CodeType, "C")'; 
