function [xHat_k,Sum_numSvs,svid_unique] = MHEstimator_test(CurrentEpoch,gnssMeas,allGpsEph,WindowSize,xo,weekNum,GT_data, count1, iono)
...
%     if CurrentEpoch-L+j-1 >514 && CurrentEpoch-L+j-1 < 651
    prM = prM - GT_data(index_GT,end-3);
      % Random Forest & FCNN-LSTM
