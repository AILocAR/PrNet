function gpsPvt = GpsWlsPvtEKF_test(gnssMeas, allGpsEph, iono, Flag_discon, bRaw)
...
GT_data = load('PrM_Bias_2021-04-28-US-SJC-1_U.csv');
...
%         WindowSize = 8;
        % N=2 in urban areas
        WindowSize = 2;
        [xHat_MHE,Sum_numSvs,svid_unique] = MHEstimator_test(i,gnssMeas,allGpsEph,WindowSize,xo_MHE,weekNum,GT_data,count_conti,iono);
