...
%   gps times corresponding to 1980/6/Jan,00:00 <= time < 2100/1/Jan,00:00
%   i.e. [0,0] <= gpsTime < [6260, 432000] 432000 is five days
...
% The original point of GPST is 00:00, 1980 Jan 6
...
while (any(days > (leap+365)))
  ...
  years(I)=years(I)+1;
  %check whether the next year is a leap year
